...
binary terms. This binary distinction is nevertheless hard-coded in this
package because it relies on a library included with the package but coded
elsewhere to associate names with genders, and this library is itself binary.
The library nevertheless allows gender associations in a very wide variety of
languages, far more than any other equivalent library, and so allows these
analyses to be applied to far greater regions of the world that would other,
